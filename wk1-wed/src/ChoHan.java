...
public class ChoHan
{
   public static void main(String[] args)
   {
      ...
      comparePlayer(player1Name, player2Name, player1 , player2);
   ...
   */
   ...
   public static void comparePlayer(String player1Name, String player2Name, Player player1, Player player2)
   {
      if (player1Name.compareTo(player2Name) == 0)
      {
         player1.setName(player1Name + "1");
         player2.setName(player2Name + "2");
      }
   }
}